...
from basicsr.archs.ae_utils import ImageFormationModel
from basicsr.archs.neural_ae_arch import NeuralExposureControl
...
class NeuralAEStereoNet(nn.Module):
    def __init__(self, max_disp=192, time_limits=[1., 20.], gain_limits=[1., 14.]):
        ...
        self.exposure_controller = NeuralExposureControl().cuda()
